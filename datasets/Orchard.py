...
# ----------------------------------------------------------------------------------------------------------------------
#
#      Class handling Orchard dataset.
#      Implements a Dataset, a Sampler, and a collate_fn
#
# ----------------------------------------------------------------------------------------------------------------------
#
#      Steven Zhang - 10/13/2023 (WIP)
#
...
class OrchardDataset(PointCloudDataset):
    """Class to handle Orchard dataset."""

    def __init__(self, config, set='training', use_potentials=True, load_data=True):
        """
        This dataset is small enough to be stored in-memory, so load all point clouds here
        """
        PointCloudDataset.__init__(self, 'Orchard')
        ...
        if self.set == 'training':
            ...
            raise ValueError('Unknown set for Orchard data: ', self.set)
...
class OrchardCustomBatch:
    """Custom batch definition with memory pinning for Orchard"""
...
def OrchardCollate(batch_data):
    return OrchardCustomBatch(batch_data)
